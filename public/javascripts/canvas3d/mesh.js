...
Canvas3D.Mesh = function() {
	...
	this._oPosition = new Canvas3D.Vec3(0,0,0); // not used at the moment
	...
	for (var o=0;o<this._oMeshData.obj.length;o++) {
		...
		for (var f=0;f<aFaces.length;f++) {
			...
			if (this._bCalcNormals) {
				var x1 = this._aVertices[oFace.a].x;
				var y1 = this._aVertices[oFace.a].y;
				var z1 = this._aVertices[oFace.a].z;

				var x2 = this._aVertices[oFace.b].x;
				var y2 = this._aVertices[oFace.b].y;
				var z2 = this._aVertices[oFace.b].z;

				var x3 = this._aVertices[oFace.c].x;
				var y3 = this._aVertices[oFace.c].y;
				var z3 = this._aVertices[oFace.c].z;

				var oNormal = new Canvas3D.Vec3(
					((y1-y2 ) * (z1-z3)) - ((z1-z2) * (y1-y3)),
